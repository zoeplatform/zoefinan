...
export default function Plano() {
  ...
  const cardBase = "rounded-3xl bg-zinc-900/60 border border-white/10 p-6 backdrop-blur-md shadow-xl h-full";

  return (
    <div className="min-h-screen bg-black px-6 pt-8 pb-32 md:pb-8 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
          ...
          <div className={cardBase}>
            ...
            <div className="space-y-4">
              <div className="bg-black/40 p-4 rounded-2xl border border-white/5">
                <p className="text-[10px] text-white/30 uppercase font-black mb-1">Meta Total (6 meses)</p>
                <p className="text-lg font-black text-white">R$ {metaReserva.toLocaleString("pt-BR")}</p>
              </div>
              <div className="bg-black/40 p-4 rounded-2xl border border-white/5">
                <p className="text-[10px] text-white/30 uppercase font-black mb-1">Aporte Mensal Sugerido</p>
        ...
        <button
          ...
          className="w-full mt-10 rounded-3xl bg-white text-black py-5 font-black text-xs uppercase tracking-[0.2em] active:scale-95 transition-all shadow-xl shadow-white/5"
        >
