      ...
      if (user) {
        try {
          ...
          if (docSnap.exists()) {
            ...
            // Lógica de meses: Usar getMonthList que já filtra a partir de Jan 2026
            const months = getMonthList(12);
            setAvailableMonths(months);
            
            // Garantir que o mês selecionado existe na lista, senão pega o último
  ...
  return (
    <div className="min-h-screen bg-black text-white p-6 pb-32">
      <header className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-2xl font-black tracking-tight">Diagnóstico</h1>
      ...
      {/* Seletor de Meses (Calendário Progressivo) */}
      ...
      <div className="bg-zinc-900/40 border border-white/10 rounded-[32px] p-7 mb-6 backdrop-blur-xl shadow-2xl">
      ...
      {/* Detalhamento */}
      <div className="bg-zinc-900/20 border border-white/5 rounded-[32px] p-2">
        <div className="bg-zinc-900/60 border border-white/10 rounded-[28px] p-6">
